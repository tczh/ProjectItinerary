<?php
//use this review not the another review.php
    class Review {
        ...
        //Last edited 10/11 7.18pm -> Need to create the API to link to this
        ...
        //SETTLE THE SQL to retrieve itinerary details table, review details table, payment table
